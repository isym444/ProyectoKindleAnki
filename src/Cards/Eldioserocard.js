    ...
    return (
        <div>
            <div className="max-w-md w-full lg:flex m-2">
                <div className="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style={{backgroundImage: "url('/Media/eldiosero.jpg')"}}>
                </div>
                ...
                <div className="mb-8">
                    ...
                    <p id="book1" className="text-grey-darker text-base">{dioseroscrollpos}%</p>
                </div>
